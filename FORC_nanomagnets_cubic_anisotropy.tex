...
\rho = \rho(B_b, B_a) = -\frac{\partial^2 M}{\partial B_a \partial B_b},
\end{equation}
...
Previous studies of FORC diagram pattern formation by minerals with cubic MCA used micromagnetics\cite{Muxworthy2004} and dipole-dipole modelling\cite{Harrison2014} to study the influence of magnetostatic interactions on the FORC diagram; however, the fully noninteracting case remains unknown as these studies rely on specific geometries (a small number of particles, positions and orientations) thus lack generality and by definition cannot completely isolate the purely noninteracting contribution. In this study we present a novel approach for numerically calculating the FORC diagram of a uniform noninteracting dispersion of SD particles with cubic MCA. The widely accepted magnetic parameters of magnetite (Fe$_3$O$_4$) (saturation magnetization $M_s=4.8\times 10^5 \, \text{A/m}$ and first anisotropy constant $K_1=-1.2\times 10^4 \, \text{J/m}^3$), iron (Fe) ($M_s=\roughly 1.7\times 10^6 \, \text{A/m}$ and $K_1=4.8\times 10^4 \, \text{J/m}^3$) and greigite (Fe$_3$S$_4$) ($M_s=\roughly 2.7\times 10^5 \, \text{A/m}$ and $K_1=-1.7\times 10^4 \, \text{J/m}^3$) have been used due to their natural abundance and importance for the Earth sciences of these iron minerals.\par
